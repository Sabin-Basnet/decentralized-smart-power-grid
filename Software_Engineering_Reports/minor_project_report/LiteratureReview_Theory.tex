...
\begin{itemize}
    ...
    \item The Localization Gap: Traditional anomaly detection systems often rely on cloud-based, centralized processing with high latency, which delays the identification of localized power theft.
